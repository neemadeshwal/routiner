...
class Step4Reflection extends StatefulWidget {
  const Step4Reflection({super.key});

  @override
  State<Step4Reflection> createState() => _Step4ReflectionState();
}

class _Step4ReflectionState extends State<Step4Reflection> {
  ...
  void _onTimeChanged(int hour, int minute, bool isAm) {
    if (!mounted) return;
      context.read<UserSetupBloc>().add(
        UserSetupReflectionSelected(hour: hour, minute: minute, isAm: isAm),
      );
    }
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      "What time do you reflect on your day?",
